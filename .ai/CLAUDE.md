---
title: EzLib Claude Agent Memory
...
# Claude Shared AI Memory

This GitHub project uses centralized AI memory.

Claude should follow the same shared memory protocol as other agents.
...
If root-level `AGENTS.md` or `CLAUDE.md` exists, read it as repo/team guidance. Do not modify root-level agent files unless the user explicitly asks.
