---
title: EzLib Codex Agent Memory
...
3. Read the central memory repo `AGENT_PROTOCOL.md`, if accessible.
4. Read `PROJECTS/Ezsoft4u-EzLib.dotnet8.Tools/.ai/PROJECT_STATE.md`, if accessible.
5. Read `PROJECTS/Ezsoft4u-EzLib.dotnet8.Tools/.ai/HANDOFF.md`, if accessible.
6. If central memory is not accessible, read repo-local `.ai/` if present.
7. If neither is available, ask the user for project memory.
